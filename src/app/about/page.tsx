        ...
        <div className={styles.section}>
            <div className={styles.container}>
                ...
                <div className={styles.knowledge}>
                    ...
                    <img className={styles.mobImage} src="/lawyer.webp" alt="Best Image" />          
                ...
                <div className={styles.knowledge}>
                    ...
                    <Image className={styles.pcImage} alt='პროფესიონალი ადვოკატი - სოფო ბერძენიშვილი და საადვოკატო ბიურო' width='400' height='650' src='/advokati.png'></Image> 
                    <img className={styles.mobImage} src="/advokati.png" alt="პროფესიონალი advokati - სოფო ბერძენიშვილი და saadvokato biuro" />          
                </div>
            </div>
        </div>
    );
